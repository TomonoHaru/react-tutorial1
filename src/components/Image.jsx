    ...
    return (
        <div>
            <figure className="image">
                <a href="public/favorite-1.jpg"><img src="public/favorite-1_th.jpg"
                    alt="Small black bird, black claws, long black slender beak, links to larger version of the image" /></a>
                <a href="public/favorite-2.jpg"><img src="public/favorite-2_th.jpg"
                ...
                <a href="public/favorite-3.jpg"><img src="public/favorite-3_th.jpg"
                ...
                <a href="public/favorite-4.jpg"><img src="public/favorite-4_th.jpg"
